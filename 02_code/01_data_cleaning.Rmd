...
# save(manual_norms, file="../unshareable_01_data/preprocessed/manual_norms.Rda")
# write.csv(manual_norms, file = "../unshareable_01_data/preprocessed/manual_norms.csv")
```
...
```{r}
census_school_type_raw <- readxl::read_excel("../01_data/raw/de_census/729305_Zensus2011_Bildung_Schulform.xlsx", 
...
census_ISCED_raw <- readxl::read_excel("../01_data/raw/de_census/729305_Zensus2011_Bildung_ISCED.xlsx", sheet = "Migration und ISCED")
...
save(census, file="../01_data/preprocessed/de_census/census.Rda")
...
save(census_margins, file="../01_data/preprocessed/de_census/census_margins.Rda")
