...
4 things are required to be able to rerun the tutorial code:
...
4. To ensure the code works as expected, it's best to have the same versions of R and the packages we use. This can be arranged by using the renv.lock file found in the main RProject folder to download the exact versions of the packages we used. Note that extra effort is needed to get _brms_ to work on your machine. Here is a [walk-through](https://learnb4ss.github.io/learnB4SS/articles/install-brms.html).